...
<div class="<?php echo $settings['iq_mixed_chart_card_show'] === 'yes' ? 'chart-card' : ''; ?>">
    <div class="">
        <?php if ($settings['iq_mixed_is_card_heading_show'] && $settings['iq_mixed_chart_card_show']) { ?>
            <h4 class="heading graphina-chart-heading" style="text-align: <?php echo $settings['iq_mixed_card_title_align'];?>;  color: <?php echo strval($settings['iq_mixed_card_title_font_color']);?>;"><?php echo esc_html__(strval($title), 'graphina-lang'); ?></h4>
        <?php }
        if ($settings['iq_mixed_is_card_desc_show'] && $settings['iq_mixed_chart_card_show']) { ?>
            <p class="sub-heading graphina-chart-sub-heading" style="text-align: <?php echo $settings['iq_mixed_card_subtitle_align'];?>;  color: <?php echo strval($settings['iq_mixed_card_subtitle_font_color']);?>;"><?php echo esc_html__(strval($description), 'graphina-lang'); ?></p>
        <?php } ?>
    </div>
