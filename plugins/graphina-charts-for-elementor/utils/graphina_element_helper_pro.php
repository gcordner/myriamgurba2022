...
function graphina_pro_element_data_enter_options($type = '', $first = false, $keys = false)
{
    switch ($type) {
        case 'main_type':
            $options = [
        ...
        case 'graphina_counter_operations':
            $options = [
                '' => esc_html__('None', 'graphina-lang'),
                'sum' => esc_html__('Sum', 'graphina-lang'),
                'avg' => esc_html__('Average', 'graphina-lang'),
                'percentage' => esc_html__('Percentage', 'graphina-lang'),
            ];
            break;
        case 'index_type':
            $options = [
                'number' => esc_html__('Number', 'graphina-lang'),
                'roman' => esc_html__('Roman Number', 'graphina-lang')
            ];
            break;
        case 'counter_layout':
            $options = [
                'layout_1' => esc_html__('Layout 1', 'graphina-lang'),
                'layout_2' => esc_html__('Layout 2', 'graphina-lang'),
                'layout_3' => esc_html__('Layout 3', 'graphina-lang'),
                'layout_4' => esc_html__('Layout 4', 'graphina-lang'),
                'layout_5' => esc_html__('Layout 5', 'graphina-lang'),
                'layout_6' => esc_html__('Layout 6', 'graphina-lang'),
            ];
            break;
        default :
            $options = [
                ...
                'remote-csv' => esc_html__('Remote CSV', 'graphina-lang'),
                'google-sheet' => esc_html__('Google Sheet', 'graphina-lang'),
                'database' => esc_html__('Database', 'graphina-lang'),
                'api' => esc_html__('API', 'graphina-lang'),
            ];
            break;
    }
...
{
    $options = [
        'table' => esc_html__('Table', 'graphina-lang'),
        'mysql-query' => esc_html__('MySQL Query', 'graphina-lang')
    ];
    if ($first) {
        return array_keys($options)[0];
    }
...
function graphina_pro_element_data_option_setting($this_ele, $type = 'element_id', $jsonData = null)
{
    if ($type != 'counter') {
        $this_ele->start_controls_section(
            ...
            [
                'label' => esc_html__('Data Options', 'graphina-lang'),
            ]
        );
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Data Json', 'graphina-lang'),
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Show Card', 'graphina-lang'),
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Upload CSV File', 'graphina-lang'),
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Select Mode', 'graphina-lang'),
            'type' => Controls_Manager::SELECT,
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Select Table', 'graphina-lang'),
            'type' => Controls_Manager::SELECT,
            'default' => '',
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Mysql Query', 'graphina-lang'),
    ...
    if ($type != 'counter') {
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('No of Rows', 'graphina-lang'),
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('No of Columns', 'graphina-lang'),
                'type' => Controls_Manager::NUMBER,
                'default' => 3,
                'min' => 1
            ]
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Show Index', 'graphina-lang'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Index Header', 'graphina-lang'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Index Title', 'graphina-lang'),
                'default' => '#',
                'condition' => [
        ...
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Index Value Type', 'graphina-lang'),
                'type' => Controls_Manager::SELECT,
    ...
    $this_ele->add_control(
        ...
        [
            ...
            'label_on' => esc_html__('No', 'graphina-lang'),
            'label_off' => esc_html__('Yes', 'graphina-lang'),
            'description' => esc_html__("It's create temporary cache of your file data and load from their for one hour in editor mode. It doesn't effect preview or live website", 'graphina-lang'),
            'default' => false,
            'condition' => [
                'iq_' . $type . '_element_data_option' => 'dynamic',
...
function graphina_pro_table_header_section($this_ele, $type = "element_id")
{
    $this_ele->start_controls_section(
        ...
        [
            'label' => esc_html__('Header', 'graphina-lang'),
        ]
    );
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Includes In Body', 'graphina-lang'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('No', 'graphina-lang'),
            'label_off' => esc_html__('Yes', 'graphina-lang'),
            'default' => "yes",
...
function graphina_pro_table_options_section($this_ele, $type = 'element_id')
{
    $this_ele->start_controls_section(
        ...
        [
            'label' => esc_html__('Table Options', 'graphina-lang'),
        ]
    );
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Responsive', 'graphina-lang'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('No', 'graphina-lang'),
            'label_off' => esc_html__('Yes', 'graphina-lang'),
            'default' => "yes",
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Search', 'graphina-lang'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Hide', 'graphina-lang'),
            'label_off' => esc_html__('Show', 'graphina-lang'),
            'default' => "",
...
function graphina_pro_table_style_section($this_ele, $type = 'element_id')
{
    $this_ele->start_controls_section(
        ...
        [
            'label' => esc_html__('Table Style', 'graphina-lang'),
...
function graphina_pro_card_style_section($this_ele, $type = 'element_id', $alignItems = false)
{
    ...
    if ($alignItems) {
        $this_ele->add_control(
            ...
            [
                'label' => esc_html__('Alignment Items', 'graphina-lang'),
                ...
                'options' => [
                    ...
                    'center' => [
                        'title' => esc_html__('Middle', 'graphina-lang'),
                        'icon' => 'fa fa-minus',
                    ],
                    'flex-end' => [
...
function graphina_pro_table_header_style_section($this_ele, $type = 'element_id')
{
    $this_ele->start_controls_section('iq_' . $type . '_header_style_section',
        [
            'label' => esc_html__('Header Style', 'graphina-lang'),
            'tab' => Controls_Manager::TAB_STYLE
        ]
    );
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('Text Alignment', 'graphina-lang'),
            'type' => Controls_Manager::CHOOSE,
            'options' => [
                'left' => [
...
function graphina_pro_counter_style_section($this_ele, $type = 'element_id', $for = 'title', $class = '')
{
    $this_ele->start_controls_section('iq_' . $type . '_count_style_section_' . $for,
        [
            'label' => esc_html__(ucfirst($for) . ' Style', 'graphina-lang'),
            'tab' => Controls_Manager::TAB_STYLE
        ]
    );
...
function graphina_pro_table_body_style_section($this_ele, $type = 'element_id')
{
    $this_ele->start_controls_section('iq_' . $type . '_body_style_section',
        [
            'label' => esc_html__('Body Style', 'graphina-lang'),
            'tab' => Controls_Manager::TAB_STYLE
        ]
    );
    ...
    $this_ele->start_controls_tab('odd', ['label' => esc_html__('Odd Row', 'graphina-lang')]);
    ...
    $this_ele->start_controls_tab('even', ['label' => esc_html__('Even Row', 'graphina-lang')]);
...
function graphina_pro_table_filter_style_section($this_ele, $type = 'element_id')
{
    $this_ele->start_controls_section('iq_' . $type . '_filter_style_section',
        [
            'label' => esc_html__('Search Style', 'graphina-lang'),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition' => [
 ...
 * @return array
 */
function graphina_pro_element_get_data_from_database($responseType = '', $type = '', $table = '', $query = '')
{
    global $wpdb;
    $results = [];
    $data = [];
...
function graphina_pro_element_get_data_from_api($api_url = '', $type = '', $this_ele = null)
{
    ...
    if($type == 'counter'){
        ...
        if(isset($settings['iq_'.$type.'_authrization_token'])
            ...
            $args['headers'] = [];
            $args['headers'][$settings['iq_'.$type.'_header_key']] = $settings['iq_'.$type.'_header_token'];
        }
...
function graphina_pro_password_style($this_ele, $type = 'chart_id' , $for='title', $class='')
{
   if($for === 'Error'){
       $this_ele->start_controls_section('iq_' . $type . '_password_form_' .$for. '_style_section_',
           [
               'label' => esc_html__('Password form '.$for, 'graphina-lang'),
               'tab' => Controls_Manager::TAB_STYLE,
               'condition' => [
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__($for, 'graphina-lang'),
    ...
    $this_ele->add_control(
        ...
        [
            'label' => esc_html__('For hover in Button keep background type classic of button', 'graphina-lang'),
            'type' => Controls_Manager::HEADING,
            'condition' => ['iq_' . $type . '_restriction_content_type' => 'password'],
        ]
    );
    ...
    $this_ele->add_control(
        ...
        [
            'label' => __( 'Text Color', 'graphina-lang' ),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'selectors' => [
    ...
    $this_ele->add_control(
        ...
        [
            'label' => __( 'Background Color', 'graphina-lang' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this_ele->add_control(
        ...
        [
            'label' => __( 'Border Color', 'graphina-lang' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
