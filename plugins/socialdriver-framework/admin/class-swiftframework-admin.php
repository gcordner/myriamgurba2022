 ...
 * @subpackage socialdriver-framework/admin
 */
...
class SwiftFramework_Admin {
	...
	public function add_swiftframework_menu() {
		//add_menu_page( 'Swift Framework', 'Swift Framework', 'manage_options', 'socialdriver-framework/admin/swift-framework-admin-page.php', '', plugin_dir_url(__FILE__).'/img/logo.png', 100 );
		add_menu_page(
		    'Swift Framework',
		    'Swift Framework',
		    'manage_options',
		...
		<div class="sf-about-wrap">
			...
			<div class="about-content">
				...
				<ul>
					...
					<li>FRONTEND: Fixed display issue with product reviews.</li>
	...
	public function enqueue_scripts() {
		...
		//wp_enqueue_script( $this->SwiftFramework, plugin_dir_url( __FILE__ ) . 'js/swiftframework-admin.js', array(), $this->version, false );
		...
		wp_enqueue_script( $this->SwiftFramework, plugin_dir_url( __FILE__ ) . 'js/swiftframework-admin.js', array(), NULL , false );
	}
