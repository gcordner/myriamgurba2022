...
= 2.5.52 =
* FRONTEND: Fixed error with icon box

= 2.5.51 =
* FRONTEND: Background video now plays on mobile devices, if supported
* FRONTEND: Fixed display issue with product reviews
* BACKEND: Fixed issue with custom padding values not saving
* BACKEND: Fixed issue with icons not loading in page builder icon elements
* BACKEND: Improved some error handling

= 2.5.50 =
* FRONTEND: Fixed flexbox display issues
* FRONTEND: Fixed issue with code snippet display
* FRONTEND: Fixed issue with Swift Slider random option
* FRONTEND: Fixed issue with Swift Slider parallax
* FRONTEND: Fixed zoomIn animation issue on Safari
* BACKEND: Added option to disable SPB History, for performance improvements
* BACKEND: Fixed Page Builder editing issue on shop page

= 2.5.46 =
* FRONTEND: Removed testimonials archive.
* BACKEND: Fixed shortcode generator issue with WordPress 4.8.

= 2.5.45 =
* FRONTEND: Added Testimonial Slider Cite image
* FRONTEND: Added plugin + theme version body class output for faster support
* FRONTEND: Fixed issue with column responsive visibility not working when extra class specified
* FRONTEND: Fixed row column vertical align issue in IE Edge
* FRONTEND: Fixed carousel showcase issue
* FRONTEND: Fixed client image sizes
* FRONTEND: Switched from matchheight to equalheights for firefox support
* MISC: Change language file to be .pot and updated strings

= 2.5.43 =
* BACKEND: Fixed page builder formatting issue when saving content with WordPress 4.8

= 2.5.42 =
* FRONTEND: Update matchHeights js script to fix column matched height issues
* FRONTEND: Fixed blog social integration
* FRONTEND: Fixed CSS issue with older browsers
* BACKEND: Fixed page builder issue when saving content with WordPress 4.8

= 2.5.40 =
* FRONTEND: Added image width/height filters for icon box image
* FRONTEND: Added Apply Filters To Team Image Sizes
* FRONTEND: Fixed outdated WooCommerce function call
* FRONTEND: Fixed Swift Slider continue button not showing
* BACKEND: Added wpml-config.xml file for WPML shortcode translation within the page builder

= 2.5.32 =
* FRONTEND: Adjusted AJAX team panel image handling, radius is now on a wrapper to allow for non-square images
* FRONTEND: Other fixes
