 ...
 * @subpackage socialdriver-framework/public
 */
...
class SwiftFramework_Public {
	...
	public function enqueue_scripts() {
		...
		//wp_enqueue_script( $this->SwiftFramework, plugin_dir_url( __FILE__ ) . 'js/swiftframework-public.js', array(), $this->version, false );
		wp_enqueue_script( 'imagesLoaded', plugin_dir_url( __FILE__ ) . 'js/lib/imagesloaded.pkgd.min.js', array(), false, true );
		wp_enqueue_script( 'jquery-viewports', plugin_dir_url( __FILE__ ) . 'js/lib/jquery.viewports.min.js', array(), false, true );
		wp_enqueue_script( 'jquery-smartresize', plugin_dir_url( __FILE__ ) . 'js/lib/jquery.smartresize.min.js', array(), false, true );
