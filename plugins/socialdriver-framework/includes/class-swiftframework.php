 ...
 * @subpackage socialdriver-framework/includes
 */
...
class SwiftFramework {
    ...
    public function include_cpts() {
        ...
        if ( $sf_opts['cpt-disable']["gallery"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/gallery-type.php' );
        }
        if ( $sf_opts['cpt-disable']["news"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/news-type.php' );
        }
        if ( $sf_opts['cpt-disable']["team"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/team-type.php' );
        }
        if ( $sf_opts['cpt-disable']["sponsor"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/sponsor-type.php' );
        }
        if ( $sf_opts['cpt-disable']["testimonials"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/testimonials-type.php' );
        }
        if ( $sf_opts['cpt-disable']["event"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/event-type.php' );
        }
        if ( $sf_opts['cpt-disable']["resource"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/resource-type.php' );
        }
        if ( $sf_opts['cpt-disable']["job"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/job-type.php' );
        }
        if ( $sf_opts['cpt-disable']["timeline"] != 1 ) {
        	include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/timeline-type.php' );
        }
        include_once( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/custom-post-types/media-category.php' );
