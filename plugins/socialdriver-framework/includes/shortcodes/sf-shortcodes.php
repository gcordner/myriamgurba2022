    ...
    */
    ...
    if ( !function_exists('sf_addtocart_button') ) {
        function sf_addtocart_button( $atts, $content = null ) {
            ...
            $button_output .= '<a href="'.$shop_page_url.'?add-to-cart='.$product_id.'" rel="nofollow" data-product_id="'.$product_id.'" class="'.$button_class.'" data-default_icon="sf-icon-add-to-cart" data-loading_text="'.__("Adding...", "swiftframework").'" data-added_text="'.__("Item added", "swiftframework").'" data-added_short="'.__("Added", "swiftframework").'" data-default_text="'.__("Add to cart", "swiftframework").'"><i class="sf-icon-add-to-cart" aria-hidden="true"></i><span>'.__("Add to cart", "swiftframework").'</span></a>';
            $button_output .= '</div>';
    ...
    if ( !function_exists('sf_button') ) {
        function sf_button( $atts, $content = null ) {
            ...
            if ( $type == "sf-icon-reveal" || $type == "sf-icon-stroke" ) {
                $button_output .= '<a id="' . $button_id . '" class="' . $button_class . '" href="' . $link . '" ';
                if ( $download == "yes" && $link != "" ) {
                    $button_output .= 'download="' . explode("/", $link)[count(explode("/", $link))-1] . '" ';
                }
                if ( $postid != "" ) {
                    $button_output .= 'data-postid="' . $postid . '" ';
                }
                $button_output .= 'target="' . $target . '" title="' . $title . '">';
                $button_output .= '<span class="text">' . do_shortcode( $content ) . '</span>';
                $button_output .= '<i class="' . $icon . '" aria-hidden="true"></i>';
                $button_output .= '</a>';
            } else {
                $button_output .= '<a id="' . $button_id . '" class="' . $button_class . '" href="' . $link . '" ';
                if ( $download == "yes" && $link != "" ) {
    ...
    if ( !function_exists('sf_icon') ) {
        function sf_icon( $atts, $content = null ) {
            ...
            if ( $image != "" ) {
                ...
                if ( $animate_svg == "yes" ) {
                    if ( $color != "" ) {
                    $style_array[] = 'stroke: ' . $color . ';';
                    }
                    $icon_output .= '<div id="sf-svg-'.$sf_svg_icon_id.'" class="sf-svg-icon-holder sf-svg-icon-animate ' . $svg_class . ' '.$svg_el_class.'" data-svg-src="' . $svg . '" data-anim-type="delayed" data-path-timing="ease-in" data-anim-timing="ease-out" style="' . implode('', $style_array) . '"></div>';
                } else {
                    if ( $color != "" ) {
                    $style_array[] = 'stroke: ' . $color . ';';
                    }
                    $icon_output .= '<div id="sf-svg-'.$sf_svg_icon_id.'" class="sf-svg-icon-holder sf-svg-icon-animate animation-disabled ' . $svg_class . ' '.$svg_el_class.'" data-svg-src="' . $svg . '" data-anim-type="delayed" data-path-timing="ease-in" data-anim-timing="ease-out" style="' . implode('', $style_array) . '"></div>';
                }
            } else {
                if ( $color != "" ) {
                $style_array[] = 'color: ' . $color . ';';
                }
                if ( $px_size != "" ) {
                $style_array[] = 'font-size: ' . $px_size . ';';
                $style_array[] = 'height: ' . $px_size . ';';
                $style_array[] = 'width: ' . $px_size . ';';
                }
                if ( $cont == "yes" ) {
                    $cont_style_array[] = 'background-color:' . $bgcolor . ';';

                    if ( $character != "" ) {
                        $icon_output .= '<div class="sf-icon-cont cont-' . $size . ' sf-icon-float-' . $float . '" style="' . implode('', $cont_style_array) . '" aria-hidden="true"><span class="sf-icon-character sf-icon sf-icon-' . $size . '" style="' . implode('', $style_array) . '">' . $character . '</span></div>';
                    } else {
                        $icon_output .= '<div class="sf-icon-cont cont-' . $size . ' sf-icon-float-' . $float . '" style="' . implode('', $cont_style_array) . '" aria-hidden="true"><i class="' . $icon . ' sf-icon sf-icon-' . $size . '" style="' . implode('', $style_array) . '" aria-hidden="true"></i></div>';
                    }
                } else {
                    if ( $character != "" ) {
                        $icon_output .= '<span class="sf-icon-character sf-icon sf-icon-float-' . $float . ' sf-icon-' . $size . '" style="' . implode('', $style_array) . '">' . $character . '</span>';
                    } else {
                        $icon_output .= '<i class="' . $icon . ' sf-icon sf-icon-float-' . $float . ' sf-icon-' . $size . '" style="' . implode('', $style_array) . '" aria-hidden="true"></i>';
                    }
                }
            }

            if ( $link != "" ) {
                $icon_output = '<a href="' . $link . '" target="' . $target . '" class="linked-icon" tabindex="-1" aria-hidden="true">' . $icon_output . '</a>';
            }
    ...
    if ( !function_exists('sf_iconbox') ) {
        function sf_iconbox( $atts, $content = null ) {
            ...
            if ( $type == "boxed-four" || $type == "standard-title" ) {
                if ( $character != "" ) {
                    if ( $link != "" ) {
                        $icon_box .= '<h3 style="color:' . $text_color . ';"><a href="' . $link . '" target="' . $target . '" title="' . esc_attr($title) . '"><span class="sf-icon-character sf-icon-' . $color . '">' . $character . '</span> ' . $title . '</a></h3>';
                    } else {
                        $icon_box .= '<h3 style="color:' . $text_color . ';"><span class="sf-icon-character sf-icon-' . $color . '">' . $character . '</span> ' . $title . '</h3>';
                    }
                } else {
                    if ( $link != "" ) {
                        $icon_box .= '<h3 style="color:' . $text_color . ';"><a href="' . $link . '" target="' . $target . '" title="' . esc_attr($title) . '"><i class="' . $icon . ' sf-icon-' . $color . '"></i> ' . $title . '</a></h3>';
                    } else {
                ...
                if ( $link != "" ) {
                    $icon_box .= '<h3 style="color:' . $text_color . ';"><a href="' . $link . '" target="' . $target . '" title="' . esc_attr($title) . '">' . $title . '</a></h3>';
                } else {
        ...
        function sf_chart( $atts ) {
            ...
            if ( $content != "" ) {
                if ( strpos( $content, 'fa-' ) !== false || strpos( $content, 'ss-' ) !== false || strpos( $content, 'sf-im-' ) !== false || strpos( $content, 'sf-icon-' ) !== false ) {
                    $chart_output .= '<span><i class="' . $content . '" aria-hidden="true"></i></span>';
                } else {
    ...
    if ( !function_exists('sf_modal') ) {
        function sf_modal( $atts, $content = null ) {
            ...
            $modal_delete_icon = apply_filters( 'sf_close_icon', '<i class="ss-delete" aria-hidden="true"></i>' );
            ...
            if ( $link_type == "text" ) {
                ...
                if ( $btn_type == "sf-icon-reveal" || $btn_type == "sf-icon-stroke" ) {
                    ...
                    $modal_output .= '<i class="' . $btn_icon . '" aria-hidden="true"></i>';
        ...
        function sf_fullscreen_video( $atts, $content = null ) {
            ...
            if ( $type == "image-button" || $type == "image-button2" || $type == "image-button3" ) {
                ...
                if ( $type == "image-button3" ) {
                    ...
                    $fw_video_output .= apply_filters( 'sf_fs_video_icon_alt', '<i class="ss-play" aria-hidden="true"></i>' );
                } else {
                    $fw_video_output .= apply_filters( 'sf_fs_video_icon', '<i class="ss-play" aria-hidden="true"></i>' );
                }  
    ...
    if ( !function_exists('sf_count') ) {
        function sf_count( $atts ) {
            ...
            if ( $icon != "" ) {
                $count_output .= '<div class="count-divider has-icon"><span class="icon-divide" style="background-color: ' . $color . ';"></span><i class="' . $icon . '" aria-hidden="true"></i><span class="icon-divide" style="background-color: ' . $color . ';"></span></div>';
            } else {
	    ...
	    function sf_social_share( $atts = null ) {
            ...
            if ( sf_current_theme() == "atelier" ) {
                ...
                if ( $center == "yes" ) {
                    ...
                    $share_output .= '<a href="https://www.facebook.com/sharer/sharer.php?u='.$page_permalink.'" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=440,width=660\');return false;" class="sf-share-link sf-share-fb"><i class="fa-facebook" aria-hidden="true"></i><span class="count">0</span></a>';
                    $share_output .= '<a href="http://twitter.com/share?text='.$page_title.'&url='.$page_permalink.'" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=440,width=660\');return false;" class="sf-share-link sf-share-twit"><i class="fa-twitter" aria-hidden="true"></i><span class="count">0</span></a>';
                    $share_output .= '<a href="http://pinterest.com/pin/create/button/?url='.$page_permalink.'&media='.$page_thumb_url.'&description='.$page_title.'" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=690,width=750\');return false;" class="sf-share-link sf-share-pin"><i class="fa-pinterest" aria-hidden="true"></i><span class="count">0</span></a>';
                    $share_output .= '</div>';
                }
                return $share_output;
            } else {
            ...
            function sf_gallery( $attr ) {
                ...
                foreach ( $attachments as $id => $attachment ) {
    				...
    				if ($image_title != "") {
    					...
    					$image_output .= apply_filters('sf_search_icon', '<i class="ss-search" aria-hidden="true"></i>');
    				}
