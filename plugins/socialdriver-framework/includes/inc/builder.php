    ...
    */
    ...
    class SwiftPageBuilder extends SFPageBuilderAbstract {
        ...
        public function saveMetaBoxes( $post_id ) {
            ...
            $value = $this->post( 'oxygen_js_status' );
            if ( $value !== null ) {
                //var_dump(sf_get_post_meta($post_id, '_spb_js_status'));
                // Get the value
                //var_dump($value);
                ...
                // Add value
                if ( sf_get_post_meta( $post_id, '_oxygen_js_status' ) == '' ) {
                    add_post_meta( $post_id, '_oxygen_js_status', $value, true );
                } // Update value
                elseif ( $value != sf_get_post_meta( $post_id, '_oxygen_js_status', true ) ) {
                    update_post_meta( $post_id, '_oxygen_js_status', $value );
                } // Delete value
                elseif ( $value == '' ) {
                    delete_post_meta( $post_id, '_oxygen_js_status', sf_get_post_meta( $post_id, '_oxygen_js_status', true ) );
                }
            }
        }
