    ...
    */
    ...
    class SPBLayout implements SPBTemplateInterface {
        ...
        public function output( $post = null ) {
            ...
            $oxygen_status = sf_get_post_meta( $post->ID, '_oxygen_js_status', true );
            if ( $oxygen_status == "" || ! isset( $oxygen_status ) ) {
                $oxygen_status = 'false';
            }
            $output .= '<input type="hidden" id="spb_js_status" name="spb_js_status" value="' . $spb_status . '" />';
            $output .= '<input type="hidden" id="oxygen_js_status" name="oxygen_js_status" value="' . $oxygen_status . '" />';
