    ...
    */
    ...
    class SFPageBuilderSetupAdmin extends SFPageBuilderSetup {
        ...
        public function spb_register_js() {
            ...
            wp_register_script( 'ilightbox-js', $this->assetURL( 'js/ilightbox.min.js' ), array(), SPB_VERSION, true );
            // wp_register_script( 'spb-maps', '//maps.google.com/maps/api/js', 'jquery', null, true );
        }
