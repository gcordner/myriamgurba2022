<?php
    ...
    Redux::setSection( $opt_name, array(
        'title' => __('General Page Builder', 'swift-builder'),
        'desc' => '',
        'subsection' => false,
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => __("Set the defailt width for the element edit modal, by default this is 700px.", 'swiftframework'),
                "default" => "700",
                "min" => "400",
                "step" => "20",
                "max" => "2000",
    ...
    Redux::setSection( $opt_name, array(
        'title' => __('Spacer Options', 'swift-builder'),
        'desc' => '',
        'subsection' => false,
        ...
        'fields' => array(
            array(
                'id'          => 'spacer_desktop',
                'type'        => 'slider',
                'title'       => __('Default Desktop Spacer', 'swiftframework'),
                'subtitle'    => __('The height of the spacer on desktop. (px).', 'swiftframework'),
                'desc'        => '',
                "default"     => "70",
                "step"        => "1",
                "min"         => "0",
            ...
            array(
                'id'          => 'spacer_tablet_land',
                'type'        => 'slider',
                'title'       => __('Default Tablet Landscape Spacer', 'swiftframework'),
                'subtitle'    => __('The height of the spacer on landscape tablet. (px).', 'swiftframework'),
                'desc'        => '',
                "default"     => "50",
                "step"        => "1",
                "min"         => "0",
            ...
            array(
                'id'          => 'spacer_tablet_port',
                'type'        => 'slider',
                'title'       => __('Default Tablet Portrait Spacer', 'swiftframework'),
                'subtitle'    => __('The height of the spacer on landscape portrait. (px).', 'swiftframework'),
                'desc'        => '',
                "default"     => "30",
                "step"        => "1",
                "min"         => "0",
            ...
            array(
                'id'          => 'spacer_mobile',
                'type'        => 'slider',
                'title'       => __('Default Mobile Spacer', 'swiftframework'),
                'subtitle'    => __('The height of the spacer on mobile. (px).', 'swiftframework'),
                'desc'        => '',
                "default"     => "30",
                "step"        => "1",
                "min"         => "0",
