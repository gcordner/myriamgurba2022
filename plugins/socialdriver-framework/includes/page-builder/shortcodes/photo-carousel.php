<?php
    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_photo_carousel extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $portfolio_carousel_item_class = apply_filters( 'spb_photo_carousel_item_class', '' );

            $items .= '<div id="carousel-' . $sf_carouselID . '" aria-label="carousel" class="photo-carousel-items carousel-items clearfix ' . $list_class . '" data-columns="' . $item_columns . '" data-auto="false">';
            ...
            while ( $portfolio_items->have_posts() ) : $portfolio_items->the_post();
                ...
                $items .= '<div itemscope data-id="id-' . $count . '" class="clearfix carousel-item portfolio-item ' . $portfolio_carousel_item_class . '">';
                    ...
                    $carousel_image = wp_get_attachment_image( $post->ID, "large" );
                    if ( $carousel_image && $carousel_image != "" ) {
                        $items .= '<div class="carousel-item  clearfix">';
                            $items .= $carousel_image;
                        $items .= '</div>';
                    }
            ...
            $output .= "\n\t" . '<div class="spb_photo_carousel_widget carousel-asset spb_content_element ' . $width . $el_class . '">';
    ...
    $params = array(
        ...
        array(
            ...
            "value"       => "12",
            "description" => __( "The number of photos to show in the carousel.", 'swift-framework-plugin' )
        ),
        array(
            "type"        => "dropdown",
        ...
        array(
            ...
            "heading"     => __( "Photo category", 'swift-framework-plugin' ),
            "param_name"  => "category",
            "value"       => sf_get_category_list( 'media_category' ),
            "description" => __( "Choose the category for the photos.", 'swift-framework-plugin' )
        )
    );
    ...
    /* SHORTCODE MAP
    ================================================== */
    SPBMap::map( 'spb_photo_carousel', array(
        "name"   => __( "Photo Carousel", 'swift-framework-plugin' ),
        "base"   => "spb_photo_carousel",
        "class"  => "spb_photo_carousel spb_carousel spb_tab_media",
