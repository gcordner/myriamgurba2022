    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_swift_slider extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $output .= "\n\t\t\t" . do_shortcode( '[swift_slider type="slider" category="' . $category . '" fullscreen="' . $fullscreen . '" max_height="' . $maxheight . '" slide_count="' . $slidecount . '" random="' . $random . '" transition="'.$transition.'" loop="' . $loop . '" nav="' . $nav . '" pagination="' . $pagination . '" autoplay="' . $autoplay . '" continue="' . $continue . '"]' );
            $output .= "\n\t\t" . '</div>';
    ...
    SPBMap::map( 'spb_swift_slider', array(
        ...
        "class"  => "spb_swiftslider spb_tab_ui",
        ...
        "params" => array(
            ...
            array(
                "type"        => "buttonset",
                "heading"     => __( "Random", 'swift-framework-plugin' ),
                "param_name"  => "random",
                "value"       => array(
                ...
                "buttonset_on"  => "yes",
                "description" => __( "Select if you'd like the slides to appear in a random order.", 'swift-framework-plugin' )
            ),
            array(
                "type"        => "textfield",
