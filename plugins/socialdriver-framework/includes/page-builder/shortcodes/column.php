    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_column extends SwiftPageBuilderShortcode {
        ...
        public function content( $atts, $content = null ) {
            ...
            extract( shortcode_atts( array(
                ...
                'col_animation'               => '',
                'col_slider_enable'       => 'no',
                'col_slider_loop'         => 'yes',
                'col_slider_freescroll'   => 'no',
                'col_slider_dots'         => 'yes',
                'col_slider_arrows'       => 'no',
                'col_slider_draggable'    => 'yes',
                'col_slider_initialindex' => '0',
                'col_slider_autoplay'     => '0',
                'col_xs'                      => '',
                'col_sm'                      => '12',
                'col_md'                      => '',
                'col_lg'                      => '',
            ...
            if ( $el_class != '' && $col_el_class == '' ) {
                $col_el_class = $el_class;
            }

            $col_el_class .= ' text-' . $text_style;
            ...
            // Data Attributes
            $col_data_atts = array();
            if ( $col_slider_enable == "yes" ) {
                $col_data_atts[] = 'data-col-slider="true"';
            }
            $col_data_atts = apply_filters('spb_col_data_atts', $col_data_atts);

            if ( $col_bg_image != "" && $img_url[0] != "" ) {
                if ( $parallax == "yes" ) {
                    if ( $col_parallax_image_movement == "stellar" ) {
                        $output .= "\n\t" . '<div class="spb-column-container spb_parallax_asset sf-parallax parallax-' . $col_parallax_image_movement . ' spb_content_element bg-type-' . $col_bg_type . ' ' . $width . ' ' . $col_res . ' ' . $col_el_class . '" data-stellar-background-ratio="' . $col_parallax_image_speed . '" ' . implode(' ', $col_data_atts) . ' ' . $animation_output . ' style="' . $inline_style . '">';
                    } else {
                        $output .= "\n\t" . '<div class="spb-column-container spb_parallax_asset sf-parallax parallax-' . $col_parallax_image_movement . ' spb_content_element bg-type-' . $col_bg_type . ' ' . $width . ' ' . $col_res . ' ' . $col_el_class . '" ' . implode(' ', $col_data_atts) . ' ' . $animation_output . ' style="' . $inline_style . '">';
                    }
                } else {
                    $output .= "\n\t" . '<div class="spb-column-container bg-type-' . $col_bg_type . ' ' . $width . ' ' . $col_res . ' ' . $col_el_class . '" ' . implode(' ', $col_data_atts) . ' ' . $animation_output . ' style="' . $inline_style . '">';
                }
            } else {
                $output .= "\n\t" . '<div class="spb-column-container bg-type-' . $col_bg_type . ' ' . $width . ' ' . $col_res . ' ' . $col_el_class . '" ' . implode(' ', $col_data_atts) . ' ' . $animation_output . ' style="' . $inline_style . '">';
            }
            $output .= "\n\t\t" . '<div class="spb-asset-content spb-column-inner row clearfix" style="'.$inner_inline_style.'">';
            if ( $block == true ) {
    ...
    $params = array(       
        ...
        array(
             ...
             "heading"    => __( "Background", 'swift-framework-plugin' ),
             "value"      => "" 
        ),
        array(
            "type"        => "colorpicker",
        ...
        array(
            "type"        => "dropdown",
            "heading"     => __( "BG Image Type", 'swift-framework-plugin' ),
        ...
        array(
            "type"        => "dropdown",
            "heading"     => __( "BG Image Movement", 'swift-framework-plugin' ),
    ...
    if ( get_option('sf_custom_theme') ) {
        /* SLIDER TAB */
        $params[] = array(
                "type"       => "section_tab",
                "param_name" => "slider_tab",
                "heading"    => __( "Slider", 'swift-framework-plugin' ),
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Enable Slider", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_enable",
            "value"       => array(
                __( "No", 'swift-framework-plugin' ) => "no",
                __( "Yes", 'swift-framework-plugin' )  => "yes"
            ),
            "buttonset_on"  => "yes",
            "description" => "Choose if you would like the column to be a slider of the inner elements."
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Loop", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_loop",
            "value"       => array(
                __( "Yes", 'swift-framework-plugin' )  => "yes",
                __( "No", 'swift-framework-plugin' ) => "no",
            ),
            "buttonset_on"  => "yes",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Set the slider to loop round endlessly.", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Page Dots", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_dots",
            "value"       => array(
                __( "Yes", 'swift-framework-plugin' )  => "yes",
                __( "No", 'swift-framework-plugin' ) => "no",
            ),
            "buttonset_on"  => "yes",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Enable page dots to show on the slider.", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Arrows", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_arrows",
            "value"       => array(
                __( "Yes", 'swift-framework-plugin' )  => "yes",
                __( "No", 'swift-framework-plugin' ) => "no",
            ),
            "buttonset_on"  => "yes",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Enable next/prev arrows to show on the slider.", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Freescroll", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_freescroll",
            "value"       => array(
                __( "No", 'swift-framework-plugin' ) => "no",
                __( "Yes", 'swift-framework-plugin' )  => "yes",
            ),
            "buttonset_on"  => "yes",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Set the slider to scroll freely.", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "buttonset",
            "heading"     => __( "Draggable", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_draggable",
            "value"       => array(
                __( "Yes", 'swift-framework-plugin' )  => "yes",
                __( "No", 'swift-framework-plugin' ) => "no",
            ),
            "buttonset_on"  => "yes",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Enables dragging and flicking on the slider.", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "textfield",
            "heading"     => __( "Autoplay", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_autoplay",
            "value"       => "0",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Set the autoplay for the slider in ms (e.g. 3000 is 3 seconds per slide).", 'swift-framework-plugin' )
        );
        $params[] = array(
            "type"        => "textfield",
            "heading"     => __( "Initial Index", 'swift-framework-plugin' ),
            "param_name"  => "col_slider_initialindex",
            "value"       => "0",
            "required"       => array("col_slider_enable", "=", "yes"),
            "description" => __( "Set the initial slide index (zero-based index).", 'swift-framework-plugin' )
        );
    ...
    $params[] = array(
         ...
         "heading"    => __( "Sizing", 'swift-framework-plugin' ),
         "value"      =>          "" 
    );
    $params[] = array(
        "type"        => "dropdown",
