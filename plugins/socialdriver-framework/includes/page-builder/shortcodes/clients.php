    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_clients extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $client_width = apply_filters( 'spb_client_img_width', $client_width );
            ...
            if ( $carousel == "yes" ) {
                $items .= '<div id="carousel-' . $sf_carouselID . '" aria-label="carousel" class="clients-items carousel-items clearfix" data-columns="' . $item_columns . '" '.$carousel_autoplay.'>';
            } else {
            ...
            while ( $clients_items->have_posts() ) : $clients_items->the_post();
                ...
                $image = wp_get_attachment_image_src( $client_image, 'full' );
