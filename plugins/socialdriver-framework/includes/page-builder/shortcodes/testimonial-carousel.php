    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_testimonial_carousel extends SwiftPageBuilderShortcode {
        ...
        public function content( $atts, $content = null ) {
            ...
            $items .= '<div id="carousel-' . $sf_carouselID . '" class="testimonials carousel-items clearfix ' . $list_class . '" data-columns="' . $columns . '" aria-label="carousel" data-auto="false">';
            ...
            while ( $testimonials->have_posts() ) : $testimonials->the_post();
                ...
                $testimonial_image = wp_get_attachment_image_src( $testimonial_image, 'full' );
                ...
                $items .= '<div class="testimonial carousel-item col-sm-12 clearfix">';
    ...
    SPBMap::map( 'spb_testimonial_carousel', array(
        ...
        "class"         => "spb_testimonial_carousel spb_carousel spb_tab_media",
