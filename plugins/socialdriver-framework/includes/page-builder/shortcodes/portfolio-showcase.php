    ...
    class SwiftPageBuilderShortcode_spb_portfolio_showcase extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            if ( $alt_display ) {
                ...
                $items .= '<div id="carousel-' . $sf_carouselID . '" aria-label="carousel" class="portfolio-showcase carousel-items staged-carousel gutters clearfix" data-columns="5" data-auto="false" data-pagination="'.$pagination.'">';
            } else {
            ...
            while ( $portfolio_items->have_posts() ) : $portfolio_items->the_post();
                ...
                if ( $alt_display) {
                    ...
                    $image = wp_get_attachment_image_src( $thumb_image, 'full' );
            ...
            if ( $alt_display) {
                $items .= '<div itemscope class="clearfix carousel-item portfolio-item gallery-item right-holder">';
                $items .= '</div>';
            }
