    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_recent_posts extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $atts["post_type"] = $post_type = $atts["recent_post_type"];
            ...
            if ( $carousel == "yes" ) {
                ...
                $items .= '<div id="carousel-' . $sf_carouselID . '" aria-label="carousel" class="recent-posts carousel-items ' . $list_class . ' clearfix" data-columns="' . $item_columns . '" data-auto="false" data-pagination="'.$pagination.'">';
            } else {
