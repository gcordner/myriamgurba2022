    ...
    */
    ...
    class SPBNavBar implements SPBTemplateInterface {
        ...
        public function getContentLayouts( $el_type = null ) {
            ...
            foreach ( SPBMap::getShortCodes() as $sc_base => $el ) {
                    ...
                    if ( $el_type == 'most_used_elements' ) {
                        ...
                        $data_pos = strpos( $el['class'], 'spb_tab_data');
                        $media_pos = strpos( $el['class'], 'spb_tab_media');
                        $ui_pos = strpos( $el['class'], 'spb_tab_ui');
                        $layout_pos = strpos( $el['class'], 'spb_tab_layout');
                      
                        if ( isset($el['class']) &&  $media_pos === false &&  $data_pos === false  && $ui_pos === false &&  $layout_pos === false ) {
        ...
        public function output( $post = null ) {
            ...
            $disable_spb_history = true;
            if ( !isset( $sf_opts['disable_spb_history'] ) ) {
                $disable_spb_history = $sf_opts['disable_spb_history'];
            }
            ...
            $output .= '<li class="dropdown-heading"><a href="#">Page Builder History</a></li><li class="divider"></li>';        
                                            
                                            $spb_history = '';

                                            if ( !$disable_spb_history ) {
                                            ...
                                            } else if ( $disable_spb_history ) {
                                                $output .=  '<li><a href="#">History option disabled.</a>';
                                            } else {
            ...
            $output .= '<div id="spb-option-slideout"> 
                            <div class="spb_elements_tabs_header"><div class="page_builder_elements_header"><div class="spb_search_tab">All</div><div class="spb_med_tab" >' . __( "Media", 'swift-framework-plugin' ) . '</div><div class="spb_data_tab" >' . __( "Data Viz.", 'swift-framework-plugin' ) . '</div><div class="spb_ui_tab">' . __( "U.I.", 'swift-framework-plugin' ) . '</div>
