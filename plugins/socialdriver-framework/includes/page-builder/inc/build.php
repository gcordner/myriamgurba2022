    ...
    */
    ...
    class SFPageBuilderSetup extends SFPageBuilderAbstract {
        ...
        public function spb_register_frontend_js() {
            ...
            wp_register_script( 'parallax', $this->frontendAssetURL( 'js/lib/jquery.parallax.min.js' ), array(), NULL, true );
            wp_register_script( 'mlparallax', $this->frontendAssetURL( 'js/lib/jquery.mlparallax.min.js' ), array(), NULL, true );
            wp_register_script( 'easypiechart', $this->frontendAssetURL( 'js/lib/jquery.easypiechart.min.js' ), array(), NULL, true );
            wp_register_script( 'countto', $this->frontendAssetURL( 'js/lib/jquery.countto.min.js' ), array(), NULL, true );
            wp_register_script( 'countdown', $this->frontendAssetURL( 'js/lib/jquery.countdown.min.js' ), array(), NULL, true );
            wp_register_script( 'vivus', $this->frontendAssetURL( 'js/lib/vivus.min.js' ), array(), NULL, true );
            wp_register_script( 'isotope', $this->frontendAssetURL( 'js/lib/isotope.pkgd.min.js' ), array(), NULL, true );
            wp_register_script( 'isotope-packery', $this->frontendAssetURL( 'js/lib/packery-mode.pkgd.min.js' ), array(), NULL, true );
            wp_register_script( 'flickity', $this->frontendAssetURL( 'js/lib/flickity.pkgd.min.js' ), array(), NULL, true );
            wp_register_script( 'equalheights', $this->frontendAssetURL( 'js/lib/jquery.equalheights.min.js' ), array(), NULL, true );
            wp_register_script( 'prism', $this->frontendAssetURL( 'js/lib/prism.js' ), array(), NULL, true );              

            // Enqueue Script
            //wp_enqueue_script('modernizr', $this->frontendAssetURL( 'js/lib/modernizr-custom.js' ), NULL, NULL, TRUE);
            if ( $enable_min_scripts && !$is_IE ) {
                wp_enqueue_script( 'spb-frontend-js-min', $this->frontendAssetURL( 'js/spb-functions.min.js' ), array(), NULL, true );
            } else {
                wp_enqueue_script( 'spb-frontend-js', $this->frontendAssetURL( 'js/spb-functions.js' ), array(), NULL, true );
    ...
    class SFPageBuilderSetupAdmin extends SFPageBuilderSetup {
        ...
        public function spb_register_js() {
            ...
            wp_register_script( 'base64', $this->assetURL( 'js/base64.js'), 'jquery' , null, true );
            ...
            wp_register_script( 'materialize', $this->assetURL( 'materialize/js/materialize.js' ), array(), SPB_VERSION, true );
            wp_register_script( 'page-builder', $this->assetURL( 'js/page-builder.js' ), array(), SPB_VERSION, true );
            wp_register_script( 'page-builder-min', $this->assetURL( 'js/page-builder.min.js' ), array(), SPB_VERSION, true );
            wp_register_script( 'spb-bootstrap', $this->assetURL( 'js/bootstrap.min.js' ), false, SPB_VERSION, true );
            wp_register_script( 'colorpicker-js', $this->assetURL( 'js/jquery.minicolors.min.js' ), array(), SPB_VERSION, true );
            wp_register_script( 'uislider-js', $this->assetURL( 'js/jquery.nouislider.min.js' ), array(), SPB_VERSION, true );
            wp_register_script( 'chosen-js', $this->assetURL( 'js/chosen.jquery.min.js' ), array(), SPB_VERSION, true );
        ...
        public function spb_register_css() {    
            ...
            wp_register_style( 'fontawesome', $this->assetURL( 'css/font-awesome.min.css' ), array(), null, 'all' );
