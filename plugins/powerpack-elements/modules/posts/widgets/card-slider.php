...
class Card_Slider extends Posts_Base {
	...
	protected function render() {
		...
		<div class="pp-card-slider-wrapper swiper-container-wrap">
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'card-slider' ) ); ?>>
		...
		foreach ( $settings['items'] as $index => $item ) {
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( $item_key ) ); ?>>
				<?php if ( 'box' === $settings['link_type'] && $item['link']['url'] ) { ?>
					...
					?>
					<a <?php echo wp_kses_post( $this->get_render_attribute_string( $box_link_key ) ); ?>></a>
				<?php } ?>
				<?php
