...
class Initializer  {
	...
	public function registerScripts(){
		...
		if( ! is_admin() && Registry::instance()->isEnabled() ){
			// Front css styles
			// wp_register_style( 'mvnAlgoliaPrediction', Registry::instance()->getPluginUrl() . 'front/assets/styles/predictions.min.css', array(), Registry::instance()->getPluginVersion() );
