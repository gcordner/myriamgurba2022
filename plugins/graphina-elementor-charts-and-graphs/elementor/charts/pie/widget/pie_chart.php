            ...
            <script>
                    ...
                    tooltip: {
                        ...
                        y: {
                            formatter: function(value) {
                                value = ("<?php !empty($settings['iq_' . $type . '_chart_label_pointer']) && esc_html_e($settings['iq_' . $type . '_chart_label_pointer']); ?>" === 'yes' &&  typeof graphinaAbbrNum  !== "undefined") ? graphinaAbbrNum(value ,  parseInt("<?php esc_html_e($settings['iq_' . $type . '_chart_label_pointer_number']); ?>") || 0 ) : value 
                                return value; 
                            }
                        }
                    },
                ...
                if("<?php echo $settings['iq_' . $type . '_chart_datalabels_format'] === 'yes'?>"){
                    ...
                    if(typeof chartDatalabelsFormat !== "undefined"){
                        chartDatalabelsFormat(pieOptions, showlabel, showValue, numberformat, prefix, postfix ,valueInStringShow, valueInStringValue);
                    }
                }
